/*
    ...
    - objetivo 2 - quando clicar no botão de troca de tema, caso o body já tenha a classe modo-escuro, remover a classe pra mudar pro modo claro e mudar a imagem pro sol
        - passo 6 - verificar se contém o modo-escuro no body
...
const imagemBotaoTroca = document.querySelector(".imagem-botao")

    // - passo 3 - dar um jeito de identificar o clique do usuário no botão de troca de tema
botaoALterarTema.addEventListener("click", () => {

    // - passo 6 - Verificar se o body contém o modo escuro
...
if(modoEscuroAtivo) {
    ...
    //- passo 8 - trocar a imagem do botão de alterar tema pra sol
    imagemBotaoTroca.setAttribute("src", "imagens/sun.png");
}else{
    // - passo 4 - adicionar a classe modo-escuro no body
    body.classList.add("modo-escuro");

    // - passo 5 - trocar a imagem do botão de alterar tema pra lua
    imagemBotaoTroca.setAttribute("src", "imagens/moon.png");
